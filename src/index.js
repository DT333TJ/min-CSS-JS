...
// 资源路径
const cssHref = location.href.indexOf('taikang') !== -1 ? 'http://10.132.23.192/starlinkdashboard' : 'http://10.154.31.90/starlinkdashboard'
const productionUrl = 'http://oa.taikang.com/starlinkdashboard'
const uatUrl = 'http://oa.tkuat.com/starlinkdashboard'
// const uatUrl = 'http://localhost:7552/starlinkdashboard'
...
export default class StarlinkDashBoard {
  ...
  openDrawer(urlObj) {
    ...
    let src = (location.href.indexOf('taikang') !== -1 ? productionUrl : uatUrl) + `/${systemCode}/dashboard?${paramsString}` +
